...
<template>
  <AppLayout>
    ...
    <div class="flex-1 flex flex-col w-full mt-20 justify-between">
      <div class="flex flex-col items-start gap-2 w-full max-w-[500px]">
        <div class="text-white text-3xl font-bold text-left break-keep">
          <p>
            <span class="text-[#D3F921] whitespace-nowrap" style="font-family: 'Poppins', sans-serif;">Q1.</span> 특정 음식에 대한
          </p>
          <p>알레르기가 있으신가요?</p>
        </div>
